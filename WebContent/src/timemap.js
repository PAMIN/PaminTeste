...
TimeMap.themes = {
	...
	ArtesVisuais: new TimeMapTheme({
        icon: GIP + "marker_artes.png",
        color: "#f24522",
        eventIconImage: "artesplasticas.png"
    }),

    CelebracoesReligiosas: new TimeMapTheme({
        icon: GIP + "marker_religiosas.png",
        color: "#100f6e",
        eventIconImage: "religiosas.png"
    }),

    Teatro: new TimeMapTheme({
        icon: GIP + "marker_cenicas.png",
        color: "#1c6b54",
        eventIconImage: "cenicas.png"
    }),

    Danca: new TimeMapTheme({
        icon: GIP + "marker_danca.png",
        color: "#bd0000",
        eventIconImage: "danca.png"
    }),

    Esportes: new TimeMapTheme({
        icon: GIP + "marker_esportes.png",
        color: "#51a6eb",
        eventIconImage: "esportes.png"
    }),

    Infantil: new TimeMapTheme({
        icon: GIP + "marker_infantis.png",
        color: "#2963a3",
        eventIconImage: "infantis.png"
    }),

    Literatura: new TimeMapTheme({
        icon: GIP + "marker_literatura.png",
        color: "#98cf18",
        eventIconImage: "literatura.png"
    }),

    Musica: new TimeMapTheme({
        icon: GIP + "marker_musica.png",
        color: "#ffb303",
        eventIconImage: "musica.png"
    }),

    Oficinas: new TimeMapTheme({
        icon: GIP + "marker_oficinas.png",
        color: "#ab0494",
        eventIconImage: "oficinaspalestras.png"
    }),

    Cinema: new TimeMapTheme({
        icon: GIP + "marker_cinema.png",
        color: "#30aa3e",
        eventIconImage: "cinema.png"
    }),
    
    Festivais: new TimeMapTheme({
        icon: GIP + "marker_festivais.png",
        color: "#606060",
        eventIconImage: "festivais.png"
    }),

    Outros: new TimeMapTheme({
        icon: GIP + "marker_outros.png",
        color: "#ef0881",
        eventIconImage: "outros.png"
    }),
